...
class block_course_ascendants_edit_form extends block_edit_form {
    ...
    function specific_definition($mform) {
        ...
        $elementstr = get_string('configcoursescopestartcategory', 'block_course_ascendants');
        $mform->addElement('select', 'config_coursescopestartcategory', $elementstr, $catoptions);
        $mform->addHelpButton('config_coursescopestartcategory', 'configcoursescopestartcategory', 'block_course_ascendants');

        $elementstr = get_string('configstringlimit', 'block_course_ascendants');
        $mform->addElement('text', 'config_stringlimit', $elementstr, array('size' => 4, 'maxlength' => 3));
        ...
        $elementstr = get_string('configcatstringfilter', 'block_course_ascendants');
        $mform->addElement('text', 'config_catstringfilter', $elementstr, array('size' => 40, 'maxlength' => 80));
        ...
        $elementstr = get_string('configcoursegroupname', 'block_course_ascendants');
        $mform->addElement('text', 'config_coursegroupname', $elementstr, array('size' => 40));
